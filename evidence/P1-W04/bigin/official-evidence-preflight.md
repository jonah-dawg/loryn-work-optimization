...
**Status:** Preliminary official evidence complete; proposed outcome unapproved
...
| Field capacity | Premier permits 25 custom fields per module. Bigin fields include dates, date-times, picklists, checkboxes, lookup, user, formula, and unique values. | Plausible fit for 16 job and 9 customer custom fields, but a complete default/custom map must precede account creation. |
...
- Map every CP-003 customer, job, and activity field to Bigin defaults or Premier custom fields.
