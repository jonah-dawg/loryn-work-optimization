...
|---|---|---|---|
| `../deliverables/window-sales-operations-master-plan.md` | Authoritative product and delivery plan | Version 1.7; current | Material scope, architecture, roadmap, risk, governance, process, or decision change |
...
| `CURRENT_STATE.md` | Authoritative restart point | P0-W02 paused at unapproved Decision 1 after CP-002 | Every sign-off, session stop, blocker, or active-work-unit change |
| `SESSION_LOG.md` | Append-only execution history | S-004 paused without sign-off; CP-002 remains the last approval | Every sign-off or session close |
