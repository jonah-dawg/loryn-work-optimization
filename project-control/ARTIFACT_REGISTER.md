...
| `SESSION_LOG.md` | Append-only execution history | S-023 records the GitHub collaborator handoff clarification; CP-003 remains the last product checkpoint | Every sign-off or session close |
