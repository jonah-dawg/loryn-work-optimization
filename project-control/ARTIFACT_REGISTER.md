...
|---|---|---|---|
| `../deliverables/window-sales-operations-master-plan.md` | Authoritative product and delivery plan | Version 1.90; current at CP-010 | Material scope, architecture, roadmap, risk, governance, process, or decision change |
...
| `CURRENT_STATE.md` | Authoritative restart point | CP-010 signed; simplified personal-CRM scope active; no active work unit | Every sign-off, session stop, blocker, or active-work-unit change |
| `SESSION_LOG.md` | Append-only execution history | S-090 records CP-010 scope correction and sign-off | Every sign-off or session close |
