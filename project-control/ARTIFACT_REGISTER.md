...
| `CURRENT_STATE.md` | Authoritative restart point | P1-W01 account creation authorized; awaiting Loryn setup | Every sign-off, session stop, blocker, or active-work-unit change |
| `SESSION_LOG.md` | Append-only execution history | S-049 records account-creation authorization; CP-004 remains the last checkpoint | Every sign-off or session close |
