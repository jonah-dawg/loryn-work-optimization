...
|---|---|---|---|
| `../deliverables/window-sales-operations-master-plan.md` | Authoritative product and delivery plan | Version 1.75; current | Material scope, architecture, roadmap, risk, governance, process, or decision change |
...
| `CURRENT_STATE.md` | Authoritative restart point | P1-W04 account gate authorized as D-102; account creation/tier inspection pending; CP-007 remains last checkpoint | Every sign-off, session stop, blocker, or active-work-unit change |
| `SESSION_LOG.md` | Append-only execution history | S-075 records D-102; CP-007 remains last checkpoint | Every sign-off or session close |
...
| `../deliverables/P1-W04-bigin-evidence-first-screening.md` | Approved P1-W04 outcome and execution contract | D-100/D-101 approved; D-102 opens bounded account/tier inspection only; configuration unapproved | Every accepted P1-W04 decision and checkpoint |
| `../evidence/P1-W04/bigin/official-evidence-preflight.md` | P1-W04 Bigin official-source evidence | Current; account gate authorized as D-102; tenant evidence pending | Every material Bigin feature, tier, cost, trial, or evidence change |
| `../evidence/P1-W04/bigin/field-capacity-preflight.md` | P1-W04 CP-003-to-Bigin field map | Documentation fit; account gate authorized as D-102; direct confirmation pending | Every direct field, module, tier, or capacity correction |
