...
|---|---|---|---|
| `../deliverables/window-sales-operations-master-plan.md` | Authoritative product and delivery plan | Version 1.81; current | Material scope, architecture, roadmap, risk, governance, process, or decision change |
...
| `CURRENT_STATE.md` | Authoritative restart point | P1-W05 outcome approved under D-105; complete contract unapproved | Every sign-off, session stop, blocker, or active-work-unit change |
| `SESSION_LOG.md` | Append-only execution history | S-081 records D-105 outcome approval, field map, and complete-contract draft | Every sign-off or session close |
...
| `../deliverables/P1-W05-freshsales-pro-evidence-first-definition.md` | Active P1-W05 outcome and execution contract | Outcome approved under D-105; complete contract unapproved | Explicit contract decision or material Freshsales work-unit change |
