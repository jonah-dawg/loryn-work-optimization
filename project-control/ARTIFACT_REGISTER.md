...
|---|---|---|---|
| `../deliverables/window-sales-operations-master-plan.md` | Authoritative product and delivery plan | Version 1.95; current through D-119 and the paused P1-W08 execution; CP-010 remains last signed checkpoint | Material scope, architecture, roadmap, risk, governance, process, or decision change |
...
| `CURRENT_STATE.md` | Authoritative restart point | P1-W08 approved under D-119; paused at OnePageCRM Google consent before account creation; Capsule and fixtures not started; CP-010 remains last signed checkpoint | Every sign-off, session stop, blocker, or active-work-unit change |
| `SESSION_LOG.md` | Append-only execution history | S-095 records D-119, bounded execution start, and the user-requested pause | Every sign-off or session close |
...
| `../deliverables/P1-W08-finalist-practical-session-contract.md` | Common synthetic practical-session definition for the two approved finalists | Approved under D-119; execution paused at OnePageCRM Google consent before account creation | Material setup discovery, session result, contract revision, or later checkpoint decision |
| `../evidence/P1-W08/execution-progress.md` | Sanitized P1-W08 setup and execution handoff | Current through the August 2 pause; no account confirmed, Capsule not started, and no fixtures or Loryn session completed | Every execution resume, blocker, setup completion, session result, or work-unit close |
