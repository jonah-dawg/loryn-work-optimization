...
|---|---|---|---|
| `../deliverables/window-sales-operations-master-plan.md` | Authoritative product and delivery plan | Version 1.96; current through both finalist setups and desktop checks under D-119; CP-010 remains last signed checkpoint | Material scope, architecture, roadmap, risk, governance, process, or decision change |
...
| `CURRENT_STATE.md` | Authoritative restart point | Both finalist setups and desktop checks complete; participant device detail and two Loryn sessions remain; CP-010 remains last signed checkpoint | Every sign-off, session stop, blocker, or active-work-unit change |
| `SESSION_LOG.md` | Append-only execution history | S-096 records both finalist setup results and the participant-session handoff | Every sign-off or session close |
...
| `../deliverables/P1-W08-finalist-practical-session-contract.md` | Common synthetic practical-session definition for the two approved finalists | Approved under D-119; both finalist setups and desktop checks complete; participant sessions remain | Material setup discovery, session result, contract revision, or later checkpoint decision |
| `../evidence/P1-W08/execution-progress.md` | Sanitized P1-W08 setup and execution handoff | Both finalist setups and desktop checks complete; no Loryn session completed | Every execution resume, blocker, setup completion, session result, or work-unit close |
