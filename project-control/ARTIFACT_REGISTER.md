...
|---|---|---|---|
| `../deliverables/window-sales-operations-master-plan.md` | Authoritative product and delivery plan | Version 1.89; current | Material scope, architecture, roadmap, risk, governance, process, or decision change |
...
| `CURRENT_STATE.md` | Authoritative restart point | P1-W06 closed at CP-009; LACRM eliminated; no active work unit | Every sign-off, session stop, blocker, or active-work-unit change |
| `SESSION_LOG.md` | Append-only execution history | S-089 records CP-009 sign-off and P1-W06 closure | Every sign-off or session close |
...
| `../deliverables/P1-W04-bigin-evidence-first-screening.md` | Signed P1-W04 work-unit contract and result | Closed at CP-008; Bigin Premier eliminated | Supersede only through an explicitly approved later Bigin work unit |
| `../evidence/P1-W04/bigin/official-evidence-preflight.md` | P1-W04 Bigin official-source evidence | Signed evidence set; CP-008 eliminated Premier | Every explicitly approved Bigin reopening or material later evidence change |
...
| `../deliverables/P1-W06-less-annoying-crm-evidence-first-definition.md` | Signed P1-W06 contract and result | Closed at CP-009; LACRM eliminated by direct M-01 failure | Supersede only through an explicitly approved later LACRM work unit |
| `../evidence/P1-W06/lacrm/official-evidence-preflight.md` | Signed P1-W06 LACRM official-source evidence | Approved evidence set at CP-009; M-01 failed directly; LACRM eliminated | Every explicitly approved LACRM reopening or material later evidence change |
...
| `../evidence/P1-W06/lacrm/public-demo-inspection.md` | Signed direct P1-W06 public-demo evidence | Approved at CP-009; M-01 failed; LACRM eliminated; no account created | Every explicitly approved LACRM reopening or later evidence change |
