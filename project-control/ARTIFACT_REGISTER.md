...
|---|---|---|---|
| `../deliverables/window-sales-operations-master-plan.md` | Authoritative product and delivery plan | Version 1.51; current | Material scope, architecture, roadmap, risk, governance, process, or decision change |
...
| `CURRENT_STATE.md` | Authoritative restart point | Free/MFA/organization confirmed; secondary administrator pending | Every sign-off, session stop, blocker, or active-work-unit change |
| `SESSION_LOG.md` | Append-only execution history | S-052 records the approved `Hazel Kaine` organization name and account progress; CP-004 remains the last checkpoint | Every sign-off or session close |
...
| `../deliverables/P1-W01-zoho-synthetic-prototype-and-evaluator-screening.md` | Active P1-W01 work-unit contract and execution record | Free/MFA/organization confirmed; secondary administrator pending; configuration gate closed | Every accepted P1-W01 decision and checkpoint |
