...
|---|---|---|---|
| `../deliverables/window-sales-operations-master-plan.md` | Authoritative product and delivery plan | Version 1.60; current | Material scope, architecture, roadmap, risk, governance, process, or decision change |
...
| `CURRENT_STATE.md` | Authoritative restart point | P1-W02 Free and organization confirmed; Loryn admin access and offer inspection pending; D-092 accepted | Every sign-off, session stop, blocker, or active-work-unit change |
| `SESSION_LOG.md` | Append-only execution history | S-061 records the synthetic-Free MFA exception and partial account-shell confirmation; CP-004 remains the last checkpoint | Every sign-off or session close |
...
| `../deliverables/P1-W02-next-crm-comparison-contract.md` | Active P1-W02 work-unit contract | Approved; Free and organization confirmed; MFA deferred under D-092; Loryn admin access and offer inspection pending | Every accepted P1-W02 decision and checkpoint |
