...
|---|---|---|---|
| `../deliverables/window-sales-operations-master-plan.md` | Authoritative product and delivery plan | Version 1.52; current | Material scope, architecture, roadmap, risk, governance, process, or decision change |
...
| `CURRENT_STATE.md` | Authoritative restart point | Zoho account setup complete; configuration authorization pending | Every sign-off, session stop, blocker, or active-work-unit change |
| `SESSION_LOG.md` | Append-only execution history | S-053 records completed Zoho account setup; CP-004 remains the last checkpoint | Every sign-off or session close |
...
| `../deliverables/P1-W01-zoho-synthetic-prototype-and-evaluator-screening.md` | Active P1-W01 work-unit contract and execution record | Account setup complete; configuration authorization pending | Every accepted P1-W01 decision and checkpoint |
