...
|---|---|---|---|
| `../deliverables/window-sales-operations-master-plan.md` | Authoritative product and delivery plan | Version 1.53; current | Material scope, architecture, roadmap, risk, governance, process, or decision change |
...
| `CURRENT_STATE.md` | Authoritative restart point | P1-W01 synthetic configuration authorized; official-evidence preflight first | Every sign-off, session stop, blocker, or active-work-unit change |
| `SESSION_LOG.md` | Append-only execution history | S-054 records synthetic-configuration authorization; CP-004 remains the last checkpoint | Every sign-off or session close |
...
| `../deliverables/P1-W01-zoho-synthetic-prototype-and-evaluator-screening.md` | Active P1-W01 work-unit contract and execution record | Configuration/testing authorized; evidence preflight in progress | Every accepted P1-W01 decision and checkpoint |
