...
- **Less Annoying CRM - active P1-W06 candidate; outcome approved, contract unapproved:** D-110 approves the evidence-first outcome and authorizes a documentation-only field model and complete-contract draft. The minimum map uses 8 Contact, 7 Prospecting, and 20 Window Sales Work custom fields within the documented unlimited-field boundary. The first stopping risk remains whether Contact-scoped Tasks and Events can preserve and surface a distinct next action for each active pipeline item without unsustainable duplicate entry. No demo interaction, account, trial, configuration, or external action is authorized.
...
- [ ] Explicitly approve or reject the complete P1-W06 execution contract before any public-demo interaction or external action.
