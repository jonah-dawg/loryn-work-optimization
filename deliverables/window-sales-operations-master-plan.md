...
- **Less Annoying CRM - active P1-W06 candidate; contract approved, public demo unapproved:** D-111 approves the bounded evaluator contract. The minimum map uses 8 Contact, 7 Prospecting, and 20 Window Sales Work custom fields within the documented unlimited-field boundary. The first stopping risk remains whether Contact-scoped Tasks and Events can preserve and surface a distinct next action for each active pipeline item without unsustainable duplicate entry. Public-demo interaction, an account, trial, configuration, and every external action still require later explicit authorization.
...
- [ ] Separately authorize or decline the bounded P1-W06 public-demo inspection.
