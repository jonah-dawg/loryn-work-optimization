...
- **Pipedrive - proposed next candidate:** official evidence shows a 14-day no-credit-card trial and positions Lite at `$14` per seat per month billed annually. Lite's 30-company-custom-field limit is plausible but tight, and its lack of hard required fields must be tested through visible exception filters before it can be considered viable.
