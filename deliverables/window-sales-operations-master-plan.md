...
**Progress:** P0-W01 was signed off at CP-001. CP-002 approved the independent-lead and prospecting scope. CP-003 approved the connected prospecting and active-job lifecycles, stage-specific next actions, communication timing, quote and handoff rules, installation/post-install outcomes, minimum CRM fields, and sanitized validation. CP-004 approved the P0-W03 platform-evaluation method: mandatory gates M-01 through M-13, twenty-two weighted criteria totaling 100, the common 0-5 scoring rule, seven exact scripts, an eight-record synthetic fixture set, evaluator evidence records, and a cap of two guided 20-minute finalist sessions for Loryn with no homework. Phase 0 is complete; Phase 1 trial work requires a separate work-unit contract and authorization before any account is created.
