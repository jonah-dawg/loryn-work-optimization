...
- Custom views, mobile dashboards, mobile calendar/activities, import/export, data backup on paid editions, user roles, and developer APIs.
...
- The signed CP-004 gates, weighted criteria, fixtures, scenarios, evidence format, and participant-burden limit.
